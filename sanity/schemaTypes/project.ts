...
export const project = defineType({
  ...
  fields: [
    ...
    defineField({name: 'description', title: 'Stary opis', type: 'text', rows: 8, hidden: true}),
    ...
    defineField({name: 'gallery', title: 'Stara galeria', type: 'array', of: [defineArrayMember(imageField)], options: {layout: 'grid'}, hidden: true}),
