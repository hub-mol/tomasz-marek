...
const projects = [
  {
    ...
    location: 'Pomorskie', surface: '230 m²', status: 'Koncepcja', layout: 'editorial', cardTone: 'dark',
    images: projectImages(['dom-drz-1.png', 'dom-drz-2.png']),
  },
  {
    slug: 'dom-kw', title: 'Dom KR', shortTitle: 'Dom KR', category: 'Dom prywatny',
    location: 'Pomorskie', surface: '370 m²', status: 'Koncepcja', layout: 'mosaic', cardTone: 'dark',
  ...
  },
  {
    ...
    location: 'Wielkopolskie', surface: '220 m²', status: 'W trakcie realizacji', layout: 'immersive', cardTone: 'light',
  ...
  },
  {
    ...
    category: 'Ruralistyka', location: 'Zachodniopomorskie', status: 'Koncepcja', layout: 'immersive', cardTone: 'dark',
  ...
  },
  {
    ...
    location: 'Zachodniopomorskie', surface: '90 m²', status: 'Zrealizowane', layout: 'editorial', cardTone: 'light',
  ...
  },
  {
    ...
    location: 'Warszawa', surface: '240 m²', status: 'Zrealizowane', layout: 'editorial', cardTone: 'light',
  ...
  },
  {
    ...
    location: 'Zachodniopomorskie', surface: '90 m²', status: 'Zrealizowane', layout: 'immersive', cardTone: 'dark',
  ...
  },
  {
    ...
    category: 'Urbanistyka', location: 'Gliwice', status: 'Koncepcja', layout: 'mosaic', cardTone: 'light',
  ...
  },
  {
    ...
    category: 'Architektura', location: 'Gdańsk', status: 'Koncepcja', layout: 'editorial', cardTone: 'dark',
